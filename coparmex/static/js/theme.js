...
document.addEventListener("DOMContentLoaded", function(event) {
	...
	// acordion toglle
	document.getElementById("actionCollapseOne").addEventListener("click", () => {
		document.getElementById("collapseTwo").classList.remove("show");
		document.getElementById("collapseThree").classList.remove("show");
	})
	document.getElementById("actionCollapseTwo").addEventListener("click", () => {
		document.getElementById("collapseOne").classList.remove("show");
		document.getElementById("collapseThree").classList.remove("show")
		// document.getElementById("collapseTwo").classList.add("show");
	})
	document.getElementById("actionCollapseThree").addEventListener("click", () => {
		document.getElementById("collapseOne").classList.remove("show");
		document.getElementById("collapseTwo").classList.remove("show");
	})
});
